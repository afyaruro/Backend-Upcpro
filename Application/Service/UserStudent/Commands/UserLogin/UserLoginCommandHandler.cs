...
namespace Application.Service.User.Commands.User
{
    public class UserLoginCommandHandler
    {
        ...
        public async Task<ResponseEntity<CreateOutputUserCommand>> HandleAsync(UserLoginCommand command)
        {
            ...
            if (isValid)
            {
                ...
                var response = new ResponseEntity<CreateOutputUserCommand>("Credenciales correctas", createOutput);
