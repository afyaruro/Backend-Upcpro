...
namespace Application.Service.User.Commands.UserUpdate
{
    public class UserUpdateCommandHandler
    {
        ...
        public async Task<bool> HandleAsync(UserUpdateInputCommand command, string userId)
        {

            var validator = new UserUpdateCommandValidator();
        ...
        private UserEntity toEntity(UserUpdateInputCommand command)
        {
